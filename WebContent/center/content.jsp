...
<div class="comment">댓글</div>
			<div class="w3-border w3-padding">
				<%if (id == null){
					%>
					<textarea rows="5" cols="108" class="comment" readonly>로그인 후 댓글 달기</textarea><%
					} else {
					%>
					<form action="commentWritePro.jsp" method="get" name = "cm"> 
						...
						<textarea rows="5" cols="108" class="w3-input w3-border" placeholder="댓글 작성" name="comment_content" id="comment_content"></textarea>
